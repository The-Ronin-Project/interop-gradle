...
class ServerPublishPluginTest {
    private lateinit var project: Project

    @BeforeEach
    fun setup() {
        project = getProject()
        project.pluginManager.apply("com.projectronin.interop.gradle.server-publish")
    }
    ...
    fun `includes interop version plugin`() {
        assertNotNull(project.plugins.findPlugin("com.projectronin.interop.gradle.server-version"))
    }
