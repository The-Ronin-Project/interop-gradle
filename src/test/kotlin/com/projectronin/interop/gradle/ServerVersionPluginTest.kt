...
class ServerVersionPluginTest {
    private lateinit var project: Project

    @BeforeEach
    fun setup() {
        project = getProject()
        project.pluginManager.apply("com.projectronin.interop.gradle.server-version")
    }
    ...
    @Test
    fun `axion sets prefix to v`() {
        assertEquals("v", project.getExtension<VersionConfig>("scmVersion").tag.prefix.get())
    }
